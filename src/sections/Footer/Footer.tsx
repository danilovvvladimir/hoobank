      ...
      <div className="container">
        <div className="footer__wrapper">
          <div className="footer__top">
            <div className="footer__about">
              <Logo extraClassName="footer__logo" />
          ...
          <div className="footer__links">
            <div className="footer__linksbox">
              <h4 className="footer__links-title">Useful Links</h4>
              <ul className="footer__useful-links-list">
            ...
            <div className="footer__linksbox">
              <h4 className="footer__links-title">Community</h4>
              <ul className="footer__community-links-list">
            ...
            <div className="footer__linksbox">
              <h4 className="footer__links-title">Partner</h4>
              <ul className="footer__partner-links-list">
        ...
        <div className="footer__copy">
          ...
          <div className="footer__copy-socials">
            <a href="http://google.com" className="footer__copy-socials-icon">
              <svg
                width="21"
                height="21"
                viewBox="0 0 21 21"
